...
BINARY_THRESHOLD = (51, 133) # Grayscale threshold for dark things... (5, 70, -23, 15, -57, 0)(18, 100, 31, -24, -21, 70)   (0, 100)
...
BINARY_THRESHOLD = (125,168) # Grayscale threshold for dark things... (5, 70, -23, 15, -57, 0)(18, 100, 31, -24, -21, 70)   (0, 100)  巡线(20, 142), 边界(127, 177)
thresholds = [(30, 0, -128, 127, -128, 127)]# [0, 144]#自定义灰度阈值
centre_thresholds = [0, 144]
...
edge_thresholds = [0, 144]

def track_edges(img):
    blobs = img.find_blobs([edge_thresholds], pixels_threshold=20, area_threshold=20, merge=False, invert = True, margin=5)
    if blobs:
        sum_x = 0
        sum_theta = 0
        for i in range(len(blobs)):
        ...
        singleline_check.rho_err = per_x
        singleline_check.theta_err = true_theta
